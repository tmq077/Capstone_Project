...
def load_data():
    with st.spinner(text="Loading and indexing food donation docs – hang tight! This should take 1-2 minutes."):
        ...
        # Load the model 
        gpt_context = ServiceContext.from_defaults(llm=OpenAI(model="gpt-3.5-turbo", temperature=0), context_window=2048, system_prompt="You are an expert in helping individual food donor looking to donate specific food items and your job is to provide detailed answer on different food support organisations. For each question, answer with the name of the organisation for the food items, provide details on how to donate them, specify the location or address of the organisation, and include any relevant information such as expiry dates and delivery instructions if available. Ensure your responses are based on the documents and resources you have access to. If you are unable to provide an answer, please state to refer to the organisation website and provide the website.")
